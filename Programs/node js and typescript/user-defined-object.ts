...
// creating Employee class object using constructor 
class Employee {
        id:number;
        name:string;
        salary:number;

        // constructor is use to do initialization 
...
let emp1 = new Employee(100,"Steven",12000);
let emp2 = new Employee(101,"John",16000);
emp1.display();
emp2.display();
